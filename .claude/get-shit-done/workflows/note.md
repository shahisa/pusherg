...
- **Global scope**: `/Users/isa/Documents/Indie Hacker Projects/pusherg/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/isa/Documents/Indie Hacker Projects/pusherg/.claude/notes/`)
...
2. Glob `/Users/isa/Documents/Indie Hacker Projects/pusherg/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/isa/Documents/Indie Hacker Projects/pusherg/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/isa/Documents/Indie Hacker Projects/pusherg/.claude/notes/` — works in any directory
